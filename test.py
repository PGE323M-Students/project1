...
class TestSolution(unittest.TestCase):
    ...
    def test_extrapolate_depth_private(self):

        depth = extrapolate_depth('Nechelik_Data.csv', 54, 22)

        ans = np.array([[98.58831598, 95.71735182],
       [98.58831598, 95.71735182]])

        np.testing.assert_allclose(depth[20:22,20:22], ans, atol=10)
